import MobileImg from "../../assets/goodzone_app.png";
import GoodzoneLogo from "../../assets/goodzoneLogo.png";
  ...
  return (
    <div id="goodzone" className="">
      <div className="container mx-auto px-4 lg:px-2 max-w-6xl py-10">
        ...
        <div className="flex  flex-col-reverse lg:flex-row gap-5 lg:gap-10  mt-16">
          <div className="lg:w-1/2 relative flex items-center justify-center rounded-3xl">
            <img src={MobileImg} alt="" className=" rounded-2xl" />
          </div>
          <div className=" lg:w-1/2">
            <span className="bg-red-100 p-2 rounded-full text-red-600 px-6 mb-8  flex items-center gap-2 w-fit">
              <IconBasket />
              E-Commerce
            </span>
            ...
            <h2 className="text-zinc-800 mt-8 text-2xl font-semibold">
              What we did?
            </h2>
...
export default GoodzoneSection;
