...
import MobileImg from "../../assets/delever_app.png";
      ...
      <div className="container mx-auto px-4 lg:px-2 max-w-6xl py-20">
        <div className="flex lg:justify-end">
          <div className=" lg:w-1/2 ">
            <SectionTitle
              title="Delever"
              className={"text-orange-500 lg:ml-10 font-extrabold"}
            />
          </div>
        </div>
        ...
        <div className="flex  flex-col-reverse lg:flex-row gap-5 lg:gap-10 xl:gap-20 mt-16">
          ...
          <div className=" lg:w-1/2">
            <span className="bg-red-100 p-2 rounded-full text-orange-600 px-6 mb-4  flex items-center gap-2 w-fit">
              <IconTruckDelivery />
              Delivery
            </span>
